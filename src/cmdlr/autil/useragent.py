...
def get_random_useragent():
    """Get the FakeUserAgent instance.

    The UserAgent instance need extra network connection to fetch the
    ...
    This behavior may cause two problems:
        ...
        2. This request are not socksifible, this a potential security issue.
